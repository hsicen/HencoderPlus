 ...
 */
class MaterialEditTextNew @JvmOverloads constructor(
    context: Context,
    ...
    init {
        val typedArray = context.obtainStyledAttributes(attrs, R.styleable.MaterialEditTextNew)
        useLabel = typedArray.getBoolean(R.styleable.MaterialEditTextNew_useLabel, useLabel)
        mLabel = typedArray.getString(R.styleable.MaterialEditTextNew_label) ?: hint.toString()
        mLabelSize = typedArray.getDimension(R.styleable.MaterialEditTextNew_labelSize, 12f.sp2px)
        mLabelColor = typedArray.getColor(R.styleable.MaterialEditTextNew_labelColor, mLabelColor)
        typedArray.recycle()
